// Installs the chat's packaged agent skills into a repository, in `.agents/skills/command-center-ai/`: a
...
export const SKILL_NAMESPACE = "command-center-ai";
...
/**
 * Replaces `<projectDir>/.agents/skills/command-center-ai/` with the packaged skills and the provenance file.
