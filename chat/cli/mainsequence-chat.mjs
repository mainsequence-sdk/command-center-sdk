...
export const usage = `Usage: mainsequence-chat skills install [--path <repository-root>]

Installs the chat's agent skills into <repository-root>/.agents/skills/chat/ (default: the current
