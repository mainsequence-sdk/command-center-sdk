...
`warning-tint` color) and Main Sequence Light rendering. No TypeScript API, theme token key, theme
ID, backend contract, JSON Schema, fixture, iframe protocol, or storage change. No backend rollout
is required.
